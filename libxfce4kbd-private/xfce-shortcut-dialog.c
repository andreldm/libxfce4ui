                          ...
                          GtkWidget          *parent)
{
  ...
  if (gdk_seat_grab (seat, gdk_screen_get_root_window (gdk_display_get_default_screen (display)),
...
#else
  if (gdk_keyboard_grab (gtk_widget_get_root_window (GTK_WIDGET (dialog)),
